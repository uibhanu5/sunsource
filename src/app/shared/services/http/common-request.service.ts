...
export class CommonRequestService {
  ...
  request(requestObject: any, postBody: any = null, httpParams: any= null, customHeaders: any = null): Observable<any> {
    return this.mainRequest(Utils.avoidShallowClone(requestObject), postBody, httpParams, customHeaders);
  }
  mainRequest(requestObject: any, postBody: any = null, httpParams: any= null, customHeaders: any = null): Observable<any> {
